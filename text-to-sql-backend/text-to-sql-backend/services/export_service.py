...
class ExportService:
    ...
    Uses the OS temp directory for cross-platform compatibility.
    """

    def __init__(self):
        # Use OS temp dir for cross-platform compatibility (works on Windows + Linux)
        self.export_dir = os.path.join(tempfile.gettempdir(), "queryforge_exports")
